...
public class NotebookWordAdapter extends RecyclerView.Adapter<NotebookWordAdapter.WorkHolder> {

    private ArrayList<NotebookWordModel> wordModelArrayList;

    private Context mContext;

    public NotebookWordAdapter(Context mContext, ArrayList<NotebookWordModel> wordModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull WorkHolder holder, int position) {
        NotebookWordModel wordModel = wordModelArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("isemail","notebook");
